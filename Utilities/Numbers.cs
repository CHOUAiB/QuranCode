...
public static class Numbers
{
    ...
    public static List<long> INTERESTING_NUMBERS = new List<long> { 57, 87, 114, 227, 229, 263, 269, 313, 319, 449, 619, 683, 729, 1034, 1433, 1729, 4021, 6236, 6555, 8317, 11261 };
    public static bool IsInteresting(this long source)
    {
        foreach (long number in INTERESTING_NUMBERS)
        {
    ...
    public static void LoadInterestingNumbers()
    {
        try
        {
            ...
            if (File.Exists(filename))
            {
                ...
                List<long> interesting_numbers = new List<long>();
                using (StreamReader reader = new StreamReader(filename))
                {
                    ...
                    while (!reader.EndOfStream)
                    {
                        try
                        {
                            ...
                            interesting_numbers.Add(long.Parse(line));
                        }
                        catch
                        {
                ...
                //if (interesting_numbers.Count > 0)
                {
                    INTERESTING_NUMBERS = interesting_numbers;
                }
            }
        }
        catch
    ...
    static Numbers()
    {
        ...
        //SavePrimes();
        //SaveAdditivePrimes();
        //SaveNonAdditivePrimes();
        //SaveComposites();
        //SaveAdditiveComposites();
        //SaveNonAdditiveComposites();
    ...
    {
        return BinarySearch(PERFECT_NUMBERS, number);
    }
    /// <summary>
    ...
    private static void GenerateAbundants()
    {
        int max = s_abundants_limit;
