...
public static class Numbers
{
    ...
    static Numbers()
    {
        ...
        //GenerateDeficients(MAX_NUMBER / 4);
        //GenerateAbundants(MAX_NUMBER / 4);
    ...
    private static string s_deficients_filename = "deficients.txt";
    ...
    private static string s_abundants_filename = "abundants.txt";
