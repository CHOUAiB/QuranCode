...
<pre>
QuranCode جفر القرءان is a numerical Quran research tool with support for any letter-value system, any translation, any reciter, search by text, numbers, similarity or letter frequency sum, letter/word statistics, word-by-word grammar, and CTRL+Click a word to display all verses with it related words.
