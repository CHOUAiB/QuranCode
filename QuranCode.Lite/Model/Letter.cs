...
namespace Model
{
    public class Letter
    {
        ...
        {
            this.word = word;
            //this.number = number; // to be filled by book.Setup
            this.number_in_word = number_in_word;
            //this.number_in_verse = number_in_verse; // to be filled by book.Setup
            //this.number_in_chapter = number_in_chapter; // to be filled by book.Setup
