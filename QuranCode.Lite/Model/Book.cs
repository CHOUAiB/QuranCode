...
namespace Model
{
    public class Book
    {
                ...
                if (s_quran_metadata != null)
                {
                    ...
                    for (int i = 0; i < s_quran_metadata.Chapters.Count; i++)
                    {
                        ...
                        if (this.verses != null)
                        {
                            ...
                            Chapter chapter = new Chapter(number, name, transliterated_name, english_name, revelation_place, revelation_order, bowing_count, chapter_verses);
                    ...
                    for (int i = 0; i < s_quran_metadata.Bowings.Count; i++)
                    {
                        ...
                        Bowing bowing = new Bowing(number, bowing_verses);
                    ...
                    for (int i = 0; i < s_quran_metadata.Groups.Count; i++)
                    {
                        ...
                        Group group = new Group(number, group_verses);
                    ...
                    for (int i = 0; i < s_quran_metadata.Quarters.Count; i++)
                    {
                        ...
                        Quarter quarter = new Quarter(number, quarter_verses);
                    ...
                    for (int i = 0; i < s_quran_metadata.Pages.Count; i++)
                    {
                        ...
                        Page page = new Page(number, page_verses);
                        this.pages.Add(page);
                    }
                    ...
                    for (int i = 0; i < s_quran_metadata.Parts.Count; i++)
                    {
                        ...
                        Part part = new Part(number, part_verses);
                        this.parts.Add(part);
                    }
                    ...
                    for (int i = 0; i < s_quran_metadata.Stations.Count; i++)
                    {
                        ...
                        Station station = new Station(number, station_verses);
        ...
        // root words
        private Dictionary<string, List<Word>> root_words = null;
        ...
        // get words
        public Dictionary<string, int> GetWordsWith(List<Verse> verses, string text, TextLocationInVerse text_location_in_verse, TextLocationInWord text_location_in_word, bool with_diacritics)
        {
        ...
        public Dictionary<string, int> GetCurrentWords(List<Verse> verses, string text, TextLocationInVerse text_location_in_verse, TextLocationInWord text_location_in_word, bool with_diacritics)
        {
            Dictionary<string, int> result = new Dictionary<string, int>();
            if (verses != null)
            {
        ...
        public Dictionary<string, int> GetNextWords(List<Verse> verses, string text, TextLocationInVerse text_location_in_verse, TextLocationInWord text_location_in_word, bool with_diacritics)
        {
            Dictionary<string, int> result = new Dictionary<string, int>();
            if (verses != null)
            {
