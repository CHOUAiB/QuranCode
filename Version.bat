...
COPY QuranCode1433.zip                  QuranCode1433_6.19.523.4.zip
COPY QuranCode1433.Source.zip           QuranCode1433_6.19.523.Source.zip
Tools\Touch\bin\Release\Touch.exe .                   6:19                  -Tools
MOVE                               NET2\QuranCode1433_6.19.523.2.zip        .
