...
Tools\Replace\bin\Release\Replace.exe NET2 Version.bat 000 647
Tools\Version\bin\Release\Version.exe .               6.19.647.4 6.19.647.4 -Tools
...
COPY QuranCode1433.zip        ..\Backup\QuranCode1433_6.19.647.zip
COPY QuranCode1433.Source.zip ..\Backup\QuranCode1433_6.19.647.Source.zip
