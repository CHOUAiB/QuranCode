    ...
    public partial class MainForm : Form
    {
        ...
        private void SaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Directory.Exists(Globals.STATISTICS_FOLDER))
            {
                ...
                {
                    filename = Globals.STATISTICS_FOLDER + "/" + LettersTextBox.Text + ".txt";
                }
                else if (ListView.Sorting == SortOrder.Ascending)
                {
                    filename = Globals.STATISTICS_FOLDER + "/" + "Asc_" + LettersTextBox.Text + ".txt";
                }
                else if (ListView.Sorting == SortOrder.Descending)
                {
                    filename = Globals.STATISTICS_FOLDER + "/" + "Desc_" + LettersTextBox.Text + ".txt";
                }
        ...
        private void DuplicateLettersCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            if (!DuplicateLettersCheckBox.Checked)
            {
                ...
                LettersTextBox.Text = m_backeup_text_with_duplicate_letters.RemoveDuplicateLetters();
            }
            else
            {
